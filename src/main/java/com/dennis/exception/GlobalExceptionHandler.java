...
import static com.dennis.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MagazaAppException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> okulOtomasyonuHandler(MagazaAppException okulOtomasyonuException){
